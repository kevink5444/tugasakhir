...
@section('content')
    <form action="{{ route('penggajian.update', $penggajian->id_penggajian) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_karyawan" class="form-control" value="{{ old('penggajian', $product->karyawan) }}" id="id_karyawan" ?? '' }}" readonly>
        </div>
        <div class="form-group">
            <label for="gaji_pokok">Gaji Pokok</label>
            <input type="number" id="gaji_pokok" name="gaji_pokok" class="form-control" value="{{ $penggajian->gaji_pokok }}" required>
        </div>
        <div class="form-group">
            <label for="bonus">Bonus</label>
            <input type="number" id="bonus" name="bonus" class="form-control" value="{{ $penggajian->bonus }}">
        </div>
        <div class="form-group">
            <label for="denda">Denda</label>
            <input type="number" id="denda" name="denda" class="form-control" value="{{ $penggajian->denda }}">
        </div>
        <div class="form-group">
            <label for="total_gaji">Total Gaji</label>
            <input type="number" id="total_gaji" name="total_gaji" class="form-control" value="{{ $penggajian->total_gaji }}" readonly>
        </div>
